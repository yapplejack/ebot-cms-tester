...
const server_1 = require("@docusaurus/core/lib/server");
const build_1 = require("@docusaurus/core/lib/commands/build");
...
async function deploy(siteDirParam = '.', cliOptions = {}) {
    logger_1.default.warn('Find me in node_modules/@docus/lib/commands and use MR PDF here')
